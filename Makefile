...
clean:
	make clean -C libft
	cd bonus && make clean -C libft
	$(RM) $(OBJS) $(OBJS_BONUS)
	echo "Clean done"

fclean:	clean
	make fclean -C libft
	cd bonus && make fclean -C libft
	$(RM) $(NAME) $(NAME_BONUS)
	echo "Fclean done"

bonus: $(OBJS_BONUS)
	cd bonus && make -C libft
	$(CC) $(CFLAGS) -o $(NAME_BONUS) $(OBJS_BONUS) $(LIBFT_OBJS_BONUS)
...
.PHONY: all clean fclean re noalgo

.SILENT: all $(NAME) bonus clean fclean $(OBJS) $(LIBFT_OBJS) $(FT_PRINTF_OBJS) $(OBJS_BONUS) noalgo nochecker
