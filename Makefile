...
#    Updated: 2022/06/09 12:03:25 by bperron          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
HEADERS_BONUS = bonus/include/checker_bonus.h
SRCS_BONUS =  bonus/src/checker_bonus.c bonus/src/error_bonus.c bonus/src/operations_single_bonus.c bonus/src/operations_push_bonus.c bonus/src/operations_multi_bonus.c bonus/src/push_swap_utils_bonus.c bonus/src/push_swap_utils2_bonus.c
...
.SILENT: all $(NAME) $(NAME_BONUS) bonus clean fclean $(OBJS) $(OBJS_BONUS)  noalgo nochecker
